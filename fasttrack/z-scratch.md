...
<li> Connexion <a href="https://docs.microsoft.com/cloud-app-security/enable-instant-visibility-protection-and-gove">d'applications featured à l'aide</a> de connecteurs d'application.</li>
...
<li> Déploiement de Cloud App Security comme preuve de concept.</li>
</ul></td>
</tr>
...
<strong>Remarque :</strong> Pour plus d'informations, voir <strong>Azure Information Protection</strong> dans Enterprise Mobility + <a href="products-and-capabilities.md#enterprise-mobility--security">Security.</a>
<ul>
