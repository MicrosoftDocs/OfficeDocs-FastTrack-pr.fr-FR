...
### <a name="considerations"></a><span data-ttu-id="a81c8-133">Considérations</span><span class="sxs-lookup"><span data-stu-id="a81c8-133">Considerations</span></span>
  ...
  - <span data-ttu-id="a81c8-141">Les listes de distribution (objets *MailEnabledGroup*) et les contacts externes (objets *MailEnabledContact*) figurant dans votre annuaire Active Directory local ne sont pas inclus dans la migration des données de boîte aux lettres.</span><span class="sxs-lookup"><span data-stu-id="a81c8-141">Distribution lists (*MailEnabledGroup* objects) and external contacts (*MailEnabledContact* objects) that exist in your on-premises Active Directory aren’t a part of mailbox data migration.</span></span> <span data-ttu-id="a81c8-142">Toutefois, vous pouvez les synchroniser à l’aide d’Azure Active Directory (Azure AD) Connect.</span><span class="sxs-lookup"><span data-stu-id="a81c8-142">However, you can synchronize them using Azure Active Directory (Azure AD) Connect.</span></span> 
...
<li><span data-ttu-id="a81c8-157">Règles de boîte aux lettres côté serveur</span><span class="sxs-lookup"><span data-stu-id="a81c8-157">Server-side mailbox rules</span></span></li>
...
<li> <span data-ttu-id="a81c8-180">Calendrier</span><span class="sxs-lookup"><span data-stu-id="a81c8-180">Calendar</span></span> </li>
...
<li> <span data-ttu-id="a81c8-205">Utilisateurs à extension messagerie</span><span class="sxs-lookup"><span data-stu-id="a81c8-205">Mail-enabled users</span></span> </li>
...
## <a name="your-responsibilities"></a><span data-ttu-id="a81c8-221">Vos responsabilités</span><span class="sxs-lookup"><span data-stu-id="a81c8-221">Your responsibilities</span></span>
...
<span data-ttu-id="a81c8-224">Vous effectuez également les activités suivantes, spécifiques aux migrations Exchange :</span><span class="sxs-lookup"><span data-stu-id="a81c8-224">You also perform the following activities, specific to Exchange migrations:</span></span>
  ...
  -  <span data-ttu-id="a81c8-238">Aidez vos utilisateurs finaux à résoudre les problèmes de migration côté client.</span><span class="sxs-lookup"><span data-stu-id="a81c8-238">Assist your end-users with remediation of client-side migration issues.</span></span>
...
<span data-ttu-id="a81c8-250">Nos services de migration des données migrent les données de ces environnements sources :</span><span class="sxs-lookup"><span data-stu-id="a81c8-250">Our data migration services migrate data from these source environments:</span></span>
...
<li> <span data-ttu-id="a81c8-291">Structure des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-291">File and folder structure</span></span> </li>
...
<td><ul>
<li> <span data-ttu-id="a81c8-336">Historique d’appartenance, versions précédentes et commentaires</span><span class="sxs-lookup"><span data-stu-id="a81c8-336">Ownership history, previous versions, and comments</span></span> </li>
...
<ul>
<li> <span data-ttu-id="a81c8-359">Date de création</span><span class="sxs-lookup"><span data-stu-id="a81c8-359">Created date</span></span> </li>
...
<td><span data-ttu-id="a81c8-413">Un ou plusieurs passages</span><span class="sxs-lookup"><span data-stu-id="a81c8-413">Single or multi-pass</span></span></td>
<td><ul>
...
<li> <span data-ttu-id="a81c8-435">Métadonnées de fichiers supplémentaires fournies par l’infrastructure de classification des fichiers (ICF)</span><span class="sxs-lookup"><span data-stu-id="a81c8-435">Additional file metadata provided by File Classification Infrastructure (FCI)</span></span> </li>
...
<li> <span data-ttu-id="a81c8-456">Autorisations liées aux fichiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-456">User-level file permissions</span></span> </li>
...
<li> <span data-ttu-id="a81c8-477">Autorisations liées aux dossiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-477">User-level folder permissions</span></span> </li>
...
<li> <span data-ttu-id="a81c8-488">Autorisations liées aux fichiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-488">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-489">Autorisations liées aux fichiers au niveau du groupe</span><span class="sxs-lookup"><span data-stu-id="a81c8-489">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-490">Métadonnées avancées et balises Box</span><span class="sxs-lookup"><span data-stu-id="a81c8-490">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="a81c8-491">Attributs de verrouillage de fichier</span><span class="sxs-lookup"><span data-stu-id="a81c8-491">File lock attributes</span></span> </li>
<li> <span data-ttu-id="a81c8-492">Conversion d’URL incorporées dans le contenu</span><span class="sxs-lookup"><span data-stu-id="a81c8-492">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="a81c8-493">Éléments jetés</span><span class="sxs-lookup"><span data-stu-id="a81c8-493">Trashed items</span></span> </li>
<li> <span data-ttu-id="a81c8-494">Documents inaccessibles ou endommagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-494">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="a81c8-495">Utilisateurs bloqués ou inactifs</span><span class="sxs-lookup"><span data-stu-id="a81c8-495">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="a81c8-496">Applications, signets, favoris et flux de travail Box</span><span class="sxs-lookup"><span data-stu-id="a81c8-496">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="a81c8-497">Contenu n’appartenant pas au compte Box migré</span><span class="sxs-lookup"><span data-stu-id="a81c8-497">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="a81c8-498">Autorisations et métadonnées de base des utilisateurs externes (<strong>remarque</strong> : utilisez les rapports Box pour identifier le contenu partagé avec des utilisateurs externes.</span><span class="sxs-lookup"><span data-stu-id="a81c8-498">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="a81c8-499">Demandez aux utilisateurs de partager à nouveau leur contenu avec les utilisateurs externes après la migration.)</span><span class="sxs-lookup"><span data-stu-id="a81c8-499">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="a81c8-500">Fichiers ou dossiers dépassant les restrictions et <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">limitations sharePoint Online actuelles</span></a> </span><span class="sxs-lookup"><span data-stu-id="a81c8-500">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="a81c8-501"><strong>Dropbox pour Teams (Standard et avancée)</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-501"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="a81c8-502">Un ou plusieurs passages</span><span class="sxs-lookup"><span data-stu-id="a81c8-502">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="a81c8-503">Documents</span><span class="sxs-lookup"><span data-stu-id="a81c8-503">Documents</span></span> </li>
<li> <span data-ttu-id="a81c8-504">Structure des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-504">File and folder structure</span></span> </li>
<li> <span data-ttu-id="a81c8-505">Autorisations liées aux dossiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-505">User-level folder permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-506">Autorisations liées aux dossiers au niveau du groupe</span><span class="sxs-lookup"><span data-stu-id="a81c8-506">Group-level folder permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-507">Fichiers inférieurs à 15 Go</span><span class="sxs-lookup"><span data-stu-id="a81c8-507">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="a81c8-508">Métadonnées de dossier et document de base :</span><span class="sxs-lookup"><span data-stu-id="a81c8-508">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="a81c8-509">Date de création</span><span class="sxs-lookup"><span data-stu-id="a81c8-509">Created date</span></span> </li>
<li> <span data-ttu-id="a81c8-510">Date de modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-510">Modified date</span></span> </li>
<li> <span data-ttu-id="a81c8-511">Créé par</span><span class="sxs-lookup"><span data-stu-id="a81c8-511">Created by</span></span> </li>
<li> <span data-ttu-id="a81c8-512">Auteur de la dernière modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-512">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="a81c8-513">Dossiers et contenus collaboratifs partagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-513">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="a81c8-514">Contenu partagé appartenant au compte Dropbox en cours de migration</span><span class="sxs-lookup"><span data-stu-id="a81c8-514">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul></td>
<td><ul>
<li> <span data-ttu-id="a81c8-515">Historique d’appartenance, versions précédentes et commentaires</span><span class="sxs-lookup"><span data-stu-id="a81c8-515">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="a81c8-516">Descriptions des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-516">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="a81c8-517">Autorisations liées aux fichiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-517">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-518">Autorisations liées aux fichiers au niveau du groupe</span><span class="sxs-lookup"><span data-stu-id="a81c8-518">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-519">Métadonnées avancées</span><span class="sxs-lookup"><span data-stu-id="a81c8-519">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="a81c8-520">Attributs de verrouillage de fichier</span><span class="sxs-lookup"><span data-stu-id="a81c8-520">File lock attributes</span></span> </li>
<li> <span data-ttu-id="a81c8-521">Conversion d’URL incorporées dans le contenu</span><span class="sxs-lookup"><span data-stu-id="a81c8-521">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="a81c8-522">Éléments jetés</span><span class="sxs-lookup"><span data-stu-id="a81c8-522">Trashed items</span></span> </li>
<li> <span data-ttu-id="a81c8-523">Documents inaccessibles ou endommagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-523">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="a81c8-524">Dossiers Dropbox non montés</span><span class="sxs-lookup"><span data-stu-id="a81c8-524">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="a81c8-525">Utilisateurs supprimés ou déconnectés</span><span class="sxs-lookup"><span data-stu-id="a81c8-525">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="a81c8-526">Papier, vitrines et espaces Dropbox</span><span class="sxs-lookup"><span data-stu-id="a81c8-526">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="a81c8-527">Applications et favoris Dropbox (épingles/étoiles)</span><span class="sxs-lookup"><span data-stu-id="a81c8-527">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="a81c8-528">Contenu n’appartenant pas au compte Dropbox migré</span><span class="sxs-lookup"><span data-stu-id="a81c8-528">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="a81c8-529">Autorisations et métadonnées de base des utilisateurs externes (<strong>remarque</strong> : utilisez les rapports Dropbox pour identifier le contenu partagé avec des utilisateurs externes.</span><span class="sxs-lookup"><span data-stu-id="a81c8-529">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="a81c8-530">Demandez aux utilisateurs de partager à nouveau leur contenu avec les utilisateurs externes après la migration.)</span><span class="sxs-lookup"><span data-stu-id="a81c8-530">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="a81c8-531">Fichiers ou dossiers dépassant les restrictions et <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">limitations sharePoint Online actuelles</span></a> </span><span class="sxs-lookup"><span data-stu-id="a81c8-531">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-onedrive-for-business-migrations"></a><span data-ttu-id="a81c8-532">Responsabilités fastTrack pour les migrations OneDrive Entreprise</span><span class="sxs-lookup"><span data-stu-id="a81c8-532">FastTrack responsibilities for OneDrive for Business migrations</span></span>

<span data-ttu-id="a81c8-533">Nos spécialistes FastTrack effectuent les activités standard pendant le projet de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-533">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="a81c8-534">Pour plus d’informations, voir les responsabilités relatives à la migration des données dans [Processus et attentes](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="a81c8-534">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

## <a name="your-responsibilities"></a><span data-ttu-id="a81c8-535">Vos responsabilités</span><span class="sxs-lookup"><span data-stu-id="a81c8-535">Your responsibilities</span></span>

<span data-ttu-id="a81c8-536">Vous effectuez les activités standard pendant le projet de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-536">You perform standard activities during the migration project.</span></span> <span data-ttu-id="a81c8-537">Pour plus d’informations, voir les responsabilités relatives à la migration des données dans [Processus et attentes](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="a81c8-537">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

<span data-ttu-id="a81c8-538">Vous effectuez également les activités suivantes, spécifiques aux migrations OneDrive Entreprise :</span><span class="sxs-lookup"><span data-stu-id="a81c8-538">You also perform the following activities, specific to OneDrive for Business migrations:</span></span>

  - <span data-ttu-id="a81c8-539">Configurez tous les sites OneDrive Entreprise ciblés par vos événements de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-539">Provision all OneDrive for Business sites that will be targeted by your migration events.</span></span>

## <a name="migration-to-microsoft-teams-and-microsoft-365-groups"></a><span data-ttu-id="a81c8-540">Migration vers Microsoft Teams et les groupes Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="a81c8-540">Migration to Microsoft Teams and Microsoft 365 Groups</span></span>

<span data-ttu-id="a81c8-541">Lorsque vous choisissez d'utiliser FastTrack pour migrer vos fichiers vers Microsoft Teams et les groupes Microsoft 365, nous fournissons des conseils de migration et des services de migration des données.</span><span class="sxs-lookup"><span data-stu-id="a81c8-541">When you choose to use FastTrack to migrate your files to Microsoft Teams and Microsoft 365 Groups, we provide migration guidance and data migration services.</span></span> <span data-ttu-id="a81c8-542">Nous vous fournissons des conseils pour vous aider à planifier votre migration, à configurer vos environnements sources et Teams et les groupes Microsoft 365, et à tirer parti de nos services de migration de données pour migrer vos fichiers.</span><span class="sxs-lookup"><span data-stu-id="a81c8-542">We provide guidance to help you plan your migration, configure your source environments and Teams and Microsoft 365 Groups, and leverage our data migration services to migrate your files.</span></span> <span data-ttu-id="a81c8-543">Vous créez et planifiez vos événements de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-543">You create and schedule your migration events.</span></span> <span data-ttu-id="a81c8-544">Nous les lançons conformément à votre planning, nous surveillons leur avancement et nous fournissons des rapports sur leur statut.</span><span class="sxs-lookup"><span data-stu-id="a81c8-544">We launch migration events in accordance with your schedule, monitor their progress, and provide status reports.</span></span> <span data-ttu-id="a81c8-545">Une fois vos événements de migration terminés, vous pouvez vous attendre à ce que les fichiers provenant de sources éligibles et correctement programmées de vos environnements sources soient migrés vers Teams et groupes Microsoft 365.</span><span class="sxs-lookup"><span data-stu-id="a81c8-545">When your migration events are completed, you can expect files from appropriately scheduled and eligible sources of your source environments to have been migrated to Teams and Microsoft 365 Groups.</span></span> <span data-ttu-id="a81c8-546">Les canaux Teams et les groupes Microsoft 365 doivent être pré-mis en service par le client avant de pouvoir migrer les données vers ces types de destination.</span><span class="sxs-lookup"><span data-stu-id="a81c8-546">Teams channels and Microsoft 365 Groups  must be pre-provisioned by the customer before they can migrate data into these destination types.</span></span> <span data-ttu-id="a81c8-547">Teams et les groupes Microsoft 365 ont une incidence sur vos autorisations sur l'emplacement de destination du fichier.</span><span class="sxs-lookup"><span data-stu-id="a81c8-547">Teams and Microsoft 365 Groups impacts your permissions on the file destination location.</span></span> <span data-ttu-id="a81c8-548">Teams et les groupes Microsoft 365 sont conçus pour permettre la collaboration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-548">Teams and Microsoft 365 Groups are built to allow collaboration.</span></span> <span data-ttu-id="a81c8-549">Le canal Teams ou le groupe Microsoft 365 déterminent qui a accès à ces fichiers lors de la migration vers ces destinations.</span><span class="sxs-lookup"><span data-stu-id="a81c8-549">The Teams channel or Microsoft 365 group determine who has access to those files when migrating into those destinations.</span></span> <span data-ttu-id="a81c8-550">FastTrack n'ajoute pas d'utilisateurs finaux ou de groupes à une autorisation de canal Teams ou de groupes Microsoft 365 pendant la migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-550">FastTrack doesn't add end users or groups to any Teams channel or Microsoft 365 Groups permission during migration.</span></span>

## <a name="considerations"></a><span data-ttu-id="a81c8-551">Considérations</span><span class="sxs-lookup"><span data-stu-id="a81c8-551">Considerations</span></span>

- <span data-ttu-id="a81c8-552">Toutes les migrations sont soumises aux quotas SharePoint Online.</span><span class="sxs-lookup"><span data-stu-id="a81c8-552">All migrations are subject to SharePoint Online quotas.</span></span> <span data-ttu-id="a81c8-553">Pour plus <a href="https://go.microsoft.com/fwlink/?LinkId=698855"> d'informations,</a> reportez-vous aux limites de SharePoint.</span><span class="sxs-lookup"><span data-stu-id="a81c8-553">Refer to <a href="https://go.microsoft.com/fwlink/?LinkId=698855"> SharePoint limits</a> for details.</span></span> 
- <span data-ttu-id="a81c8-554">Nous vous recommandons de limiter le volume total des données migrées à 75 % du quota de stockage SharePoint Online total auquel vous êtes autorisé (y compris le stockage supplémentaire que vous avez peut-être acheté séparément).</span><span class="sxs-lookup"><span data-stu-id="a81c8-554">We recommend that you limit the overall amount of migrate to 75 percent of the overall SharePoint Online storage quota to which you are entitled (including the additional storage you may have purchased separately).</span></span> 


## <a name="source-environment-details"></a><span data-ttu-id="a81c8-555">Détails de l’environnement source</span><span class="sxs-lookup"><span data-stu-id="a81c8-555">Source environment details</span></span>

<span data-ttu-id="a81c8-556">Nos services de migration des données migrent les données de ces environnements sources :</span><span class="sxs-lookup"><span data-stu-id="a81c8-556">Our data migration services migrate data from these source environments:</span></span> 

- <span data-ttu-id="a81c8-557">Partages de fichiers (partages de fichiers SMB (Server Message Block) sur des appareils prenant en charge SMB 2.0 et versions ultérieures).</span><span class="sxs-lookup"><span data-stu-id="a81c8-557">File shares (Server Message Block (SMB) file shares on devices supporting SMB 2.0 onward).</span></span>
-  <span data-ttu-id="a81c8-558">Environnement G Suite unique (Google Drive uniquement).</span><span class="sxs-lookup"><span data-stu-id="a81c8-558">A single G Suite environment (Google Drive only).</span></span> 
- <span data-ttu-id="a81c8-559">Box (Starter, Business, Enterprise).</span><span class="sxs-lookup"><span data-stu-id="a81c8-559">Box (Starter, Business, Enterprise).</span></span> 
- <span data-ttu-id="a81c8-560">Dropbox pour Teams (Standard et avancée).</span><span class="sxs-lookup"><span data-stu-id="a81c8-560">Dropbox for Teams (Standard and Advanced).</span></span> 

<span data-ttu-id="a81c8-561">Le tableau suivant répertorie les détails de la migration propres à chaque environnement source :</span><span class="sxs-lookup"><span data-stu-id="a81c8-561">The following table presents migration details specific to each source environment:</span></span>

<table>
<thead>
<tr class="header">
 <th><span data-ttu-id="a81c8-562"><strong>Environnement source</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-562"><strong>Source environment</strong></span></span></th>
 <th><span data-ttu-id="a81c8-563"><strong>Type de migration</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-563"><strong>Type of migration</strong></span></span></th>
 <th><span data-ttu-id="a81c8-564"><strong>Ce qui est migré</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-564"><strong>What migrates</strong></span></span></th>
 <th><span data-ttu-id="a81c8-565"><strong>Ce qui n’est pas migré</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-565"><strong>What doesn't migrate</strong></span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><span data-ttu-id="a81c8-566"><strong>N’importe quel appareil de partage de fichiers prenant en charge SMB 2.0 et versions ultérieures</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-566"><strong>Any file share device supporting SMB 2.0 onward</strong></span></span></td>
<td><span data-ttu-id="a81c8-567">Un ou plusieurs passages</span><span class="sxs-lookup"><span data-stu-id="a81c8-567">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="a81c8-568">Documents</span><span class="sxs-lookup"><span data-stu-id="a81c8-568">Documents</span></span> </li>
<li> <span data-ttu-id="a81c8-569">Structure des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-569">File and folder structure</span></span> </li>
<li> <span data-ttu-id="a81c8-570">Autorisations liées aux fichiers et aux dossiers au niveau de l'utilisateur\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-570">User-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-571">Autorisations liées aux fichiers et aux dossiers au niveau du groupe\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-571">Group-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-572">Fichiers inférieurs à 15 Go</span><span class="sxs-lookup"><span data-stu-id="a81c8-572">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="a81c8-573">Métadonnées de dossier et document de base :</span><span class="sxs-lookup"><span data-stu-id="a81c8-573">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="a81c8-574">Date de création</span><span class="sxs-lookup"><span data-stu-id="a81c8-574">Created date</span></span> </li>
<li> <span data-ttu-id="a81c8-575">Date de modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-575">Modified date</span></span> </li>
<li> <span data-ttu-id="a81c8-576">Créé par</span><span class="sxs-lookup"><span data-stu-id="a81c8-576">Created by</span></span> </li>
<li> <span data-ttu-id="a81c8-577">Auteur de la dernière modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-577">Last modified by</span></span> </li>
</ul></li>
</ul>
<br>
<span data-ttu-id="a81c8-578">\*Configuration de la synchronisation d’annuaires requise.</span><span class="sxs-lookup"><span data-stu-id="a81c8-578">\*Directory synchronization configuration required.</span></span> <span data-ttu-id="a81c8-579">Seules les autorisations NTFS exposées à l’Explorateur de fichiers Windows sont migrées.</span><span class="sxs-lookup"><span data-stu-id="a81c8-579">Only NTFS permissions exposed to the Windows File Explorer are migrated.</span></span> <span data-ttu-id="a81c8-580">Les autorisations gérées directement sur les appareils de partage de fichiers ne sont pas migrées.</span><span class="sxs-lookup"><span data-stu-id="a81c8-580">Permissions managed directly on file share devices are not migrated.</span></span> <span data-ttu-id="a81c8-581">Si les données sont stockées sur un appareil SMB 2.0, les autorisations équivalentes à NTFS exposées par le protocole SMB sont migrées.</span><span class="sxs-lookup"><span data-stu-id="a81c8-581">If data is stored on an SMB 2.0 device, the NTFS-equivalent permissions exposed by the SMB protocol are migrated.</span></span> <span data-ttu-id="a81c8-582">Les autorisations sont impactées par le groupe Microsoft 365 et/ou le canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-582">Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="a81c8-583">Si la destination est un groupe Microsoft 365 ou un canal Microsoft Teams, le groupe ou le canal détermine le profil d'autorisations final sur les fichiers migrés.</span><span class="sxs-lookup"><span data-stu-id="a81c8-583">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="a81c8-584">Nous vous recommandons de ne pas migrer les autorisations sur les fichiers migrés vers un groupe Microsoft 365 ou un canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-584">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span></td>
<td><ul>
<li> <span data-ttu-id="a81c8-585">Historique d’appartenance et versions antérieures</span><span class="sxs-lookup"><span data-stu-id="a81c8-585">Ownership history and previous versions</span></span> </li>
<li> <span data-ttu-id="a81c8-586">Conversion d’URL incorporées dans le contenu</span><span class="sxs-lookup"><span data-stu-id="a81c8-586">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="a81c8-587">Versions antérieures</span><span class="sxs-lookup"><span data-stu-id="a81c8-587">Previous versions</span></span> </li>
<li> <span data-ttu-id="a81c8-588">Attributs de fichiers et dossiers Windows (par exemple, en lecture seule et masqués)</span><span class="sxs-lookup"><span data-stu-id="a81c8-588">Windows file and folder attributes (like read-only and hidden)</span></span> </li>
<li> <span data-ttu-id="a81c8-589">Paramètres spéciaux et autorisations avancées NTFS (New Technology File System) et autres que NTFS :</span><span class="sxs-lookup"><span data-stu-id="a81c8-589">Non-Windows New Technology File System (NTFS) and NTFS advanced permissions and special settings:</span></span> </li>
<li> <span data-ttu-id="a81c8-590">Refus explicite d’autorisations (supprimées après la migration, contenu soumis à des autorisations parallèles ou des autorisations sur un dossier parent)</span><span class="sxs-lookup"><span data-stu-id="a81c8-590">Explicit deny permissions (removed after migration, content subject to parallel permissions or permissions on parent folder)</span></span> </li>
<li> <span data-ttu-id="a81c8-591">Configuration de l’audit NTFS</span><span class="sxs-lookup"><span data-stu-id="a81c8-591">NTFS auditing configuration</span></span> </li>
<li> <span data-ttu-id="a81c8-592">Métadonnées de fichiers supplémentaires fournies par l’infrastructure de classification des fichiers (ICF)</span><span class="sxs-lookup"><span data-stu-id="a81c8-592">Additional file metadata provided by File Classification Infrastructure (FCI)</span></span> </li>
<li> <span data-ttu-id="a81c8-593">Documents inaccessibles ou endommagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-593">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="a81c8-594">Partages masqués</span><span class="sxs-lookup"><span data-stu-id="a81c8-594">Hidden shares</span></span> </li>
<li> <span data-ttu-id="a81c8-595">Partage (par exemple, autorisations accordées au niveau de partage)</span><span class="sxs-lookup"><span data-stu-id="a81c8-595">Sharing (like permissions granted on the share level)</span></span> </li>
<li> <span data-ttu-id="a81c8-596">Fichiers ou dossiers dépassant les restrictions et <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">limitations sharePoint Online actuelles</span></a> </span><span class="sxs-lookup"><span data-stu-id="a81c8-596">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="a81c8-597"><strong>Environnement G Suite unique (Google Drive uniquement)</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-597"><strong>Single G Suite environment (Google Drive only)</strong></span></span></td>
<td><span data-ttu-id="a81c8-598">Un ou plusieurs passages</span><span class="sxs-lookup"><span data-stu-id="a81c8-598">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="a81c8-599">Google Docs, Sheets et Slides (fichiers convertis au format Office équivalent, y compris ceux de plus de 10 Mo)</span><span class="sxs-lookup"><span data-stu-id="a81c8-599">Google Docs, Sheets, and Slides (files are converted to the equivalent Office format including those over 10 MB)</span></span> </li>
<li> <span data-ttu-id="a81c8-600">Structure des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-600">File and folder structure</span></span> </li>
<li> <span data-ttu-id="a81c8-601">Autorisations de dossier au niveau de l'utilisateur\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-601">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-602">Autorisations de dossier au niveau du groupe\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-602">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-603">Fichiers inférieurs à 15 Go</span><span class="sxs-lookup"><span data-stu-id="a81c8-603">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="a81c8-604">Métadonnées de dossier et document de base :</span><span class="sxs-lookup"><span data-stu-id="a81c8-604">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="a81c8-605">Date de création</span><span class="sxs-lookup"><span data-stu-id="a81c8-605">Created date</span></span> </li>
<li> <span data-ttu-id="a81c8-606">Date de modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-606">Modified date</span></span> </li>
<li> <span data-ttu-id="a81c8-607">Créé par</span><span class="sxs-lookup"><span data-stu-id="a81c8-607">Created by</span></span> </li>
<li> <span data-ttu-id="a81c8-608">Auteur de la dernière modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-608">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="a81c8-609">Lecteurs partagés (dossiers et fichiers)</span><span class="sxs-lookup"><span data-stu-id="a81c8-609">Shared drives (folders and files)</span></span> </li>
<li> <span data-ttu-id="a81c8-610">Contenu partagé appartenant au compte Google Drive en cours de migration</span><span class="sxs-lookup"><span data-stu-id="a81c8-610">Shared content owned by the Google Drive account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="a81c8-611">\*Les autorisations sont impactées par le groupe Microsoft 365 et/ou le canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-611">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="a81c8-612">Si la destination est un groupe Microsoft 365 ou un canal Microsoft Teams, le groupe ou le canal détermine le profil des autorisations finales sur les fichiers migrés.</span><span class="sxs-lookup"><span data-stu-id="a81c8-612">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="a81c8-613">Nous vous recommandons de ne pas migrer les autorisations sur les fichiers migrés vers un groupe Microsoft 365 ou un canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-613">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> 
</td>
<td><ul>
<li> <span data-ttu-id="a81c8-614">Historique d’appartenance, versions précédentes et commentaires</span><span class="sxs-lookup"><span data-stu-id="a81c8-614">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="a81c8-615">Descriptions des fichiers et des dossiers, couleurs des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-615">File and folder descriptions, folder colors</span></span> </li>
<li> <span data-ttu-id="a81c8-616">Autorisations liées aux fichiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-616">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-617">Autorisations liées aux fichiers au niveau du groupe</span><span class="sxs-lookup"><span data-stu-id="a81c8-617">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-618">Métadonnées avancées</span><span class="sxs-lookup"><span data-stu-id="a81c8-618">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="a81c8-619">Attributs de verrouillage de fichier</span><span class="sxs-lookup"><span data-stu-id="a81c8-619">File lock attributes</span></span> </li>
<li> <span data-ttu-id="a81c8-620">Conversion d’URL incorporées dans le contenu</span><span class="sxs-lookup"><span data-stu-id="a81c8-620">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="a81c8-621">Éléments jetés</span><span class="sxs-lookup"><span data-stu-id="a81c8-621">Trashed items</span></span> </li>
<li> <span data-ttu-id="a81c8-622">Documents inaccessibles ou endommagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-622">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="a81c8-623">Utilisateurs bloqués ou inactifs</span><span class="sxs-lookup"><span data-stu-id="a81c8-623">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="a81c8-624">Google Photos, Forms, Maps et autres applications connectées</span><span class="sxs-lookup"><span data-stu-id="a81c8-624">Google Photos Forms, Maps, and other connected apps</span></span> </li>
<li> <span data-ttu-id="a81c8-625">Google Drawings</span><span class="sxs-lookup"><span data-stu-id="a81c8-625">Google Drawings</span></span> </li>
<li> <span data-ttu-id="a81c8-626">Contenu partagé externe à votre organisation</span><span class="sxs-lookup"><span data-stu-id="a81c8-626">Shared content external to your organization</span></span> </li>
<li> <span data-ttu-id="a81c8-627">Le contenu n’appartient pas au compte Google Drive migré</span><span class="sxs-lookup"><span data-stu-id="a81c8-627">Content not owned by the Google Drive account being migrated</span></span> </li>
<li> <span data-ttu-id="a81c8-628">Autorisations et métadonnées de base des utilisateurs externes (<strong>remarque</strong> : utilisez les rapports d’administrateur Google Drive pour identifier le contenu partagé avec des utilisateurs externes.</span><span class="sxs-lookup"><span data-stu-id="a81c8-628">Permissions and basic metadata of external users (<strong>Note</strong>: Use Google Drive Admin reports to identify content shared with external users.</span></span> <span data-ttu-id="a81c8-629">Demandez aux utilisateurs de partager à nouveau leur contenu avec les utilisateurs externes après la migration.)</span><span class="sxs-lookup"><span data-stu-id="a81c8-629">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="a81c8-630">Autorisations d’appartenance pour les disques partagés (<strong>remarque</strong> : utilisez les rapports d’administrateur Google Drive afin d’identifier l’appartenance des disques partagés.</span><span class="sxs-lookup"><span data-stu-id="a81c8-630">Shared drive membership permissions (<strong>Note</strong>: Use Google Drive Admin reports to identify shared drive memberships.</span></span> <span data-ttu-id="a81c8-631">Demandez aux utilisateurs de configurer ces paramètres d’appartenance sur la cible avant la migration.)</span><span class="sxs-lookup"><span data-stu-id="a81c8-631">Instruct end users to configure these membership settings on the target before migration.)</span></span> </li>
<li> <span data-ttu-id="a81c8-632">Fichiers ou dossiers dépassant les restrictions et <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">limitations sharePoint Online actuelles</span></a> </span><span class="sxs-lookup"><span data-stu-id="a81c8-632">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="a81c8-633"><strong>Box (Starter, Business, Enterprise)</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-633"><strong>Box (Starter, Business, Enterprise)</strong></span></span></td>
<td><span data-ttu-id="a81c8-634">Un ou plusieurs passages</span><span class="sxs-lookup"><span data-stu-id="a81c8-634">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="a81c8-635">Documents</span><span class="sxs-lookup"><span data-stu-id="a81c8-635">Documents</span></span> </li>
<li> <span data-ttu-id="a81c8-636">Structure des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-636">File and folder structure</span></span> </li>
<li> <span data-ttu-id="a81c8-637">Autorisations de dossier au niveau de l'utilisateur\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-637">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-638">Autorisations de dossier au niveau du groupe\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-638">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-639">Fichiers inférieurs à 15 Go</span><span class="sxs-lookup"><span data-stu-id="a81c8-639">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="a81c8-640">Métadonnées de dossier et document de base :</span><span class="sxs-lookup"><span data-stu-id="a81c8-640">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="a81c8-641">Date de création</span><span class="sxs-lookup"><span data-stu-id="a81c8-641">Created date</span></span> </li>
<li> <span data-ttu-id="a81c8-642">Date de modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-642">Modified date</span></span> </li>
<li> <span data-ttu-id="a81c8-643">Créé par</span><span class="sxs-lookup"><span data-stu-id="a81c8-643">Created by</span></span> </li>
<li> <span data-ttu-id="a81c8-644">Auteur de la dernière modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-644">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="a81c8-645">Contenu partagé appartenant au compte Box en cours de migration</span><span class="sxs-lookup"><span data-stu-id="a81c8-645">Shared content owned by the Box account being migrated</span></span> </li>
<li> <span data-ttu-id="a81c8-646">Notes Box (converties au format de document Word)</span><span class="sxs-lookup"><span data-stu-id="a81c8-646">Box Notes (converted to Word document format)</span></span> </li>
</ul>
<br>
<span data-ttu-id="a81c8-647">\*Les autorisations sont impactées par le groupe Microsoft 365 et/ou le canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-647">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="a81c8-648">Si la destination est un groupe Microsoft 365 ou un canal Microsoft Teams, le groupe ou le canal détermine le profil d'autorisations final sur les fichiers migrés.</span><span class="sxs-lookup"><span data-stu-id="a81c8-648">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="a81c8-649">Nous vous recommandons de ne pas migrer les autorisations sur les fichiers migrés vers un groupe Microsoft 365 ou un canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-649">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> </td>
<td><ul>
<li> <span data-ttu-id="a81c8-650">Historique d’appartenance, versions précédentes et commentaires</span><span class="sxs-lookup"><span data-stu-id="a81c8-650">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="a81c8-651">Descriptions des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-651">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="a81c8-652">Autorisations liées aux fichiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-652">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-653">Autorisations liées aux fichiers au niveau du groupe</span><span class="sxs-lookup"><span data-stu-id="a81c8-653">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-654">Métadonnées avancées et balises Box</span><span class="sxs-lookup"><span data-stu-id="a81c8-654">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="a81c8-655">Attributs de verrouillage de fichier</span><span class="sxs-lookup"><span data-stu-id="a81c8-655">File lock attributes</span></span> </li>
<li> <span data-ttu-id="a81c8-656">Conversion d’URL incorporées dans le contenu</span><span class="sxs-lookup"><span data-stu-id="a81c8-656">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="a81c8-657">Éléments jetés</span><span class="sxs-lookup"><span data-stu-id="a81c8-657">Trashed items</span></span> </li>
<li> <span data-ttu-id="a81c8-658">Documents inaccessibles ou endommagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-658">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="a81c8-659">Utilisateurs bloqués ou inactifs</span><span class="sxs-lookup"><span data-stu-id="a81c8-659">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="a81c8-660">Applications, signets, favoris et flux de travail Box</span><span class="sxs-lookup"><span data-stu-id="a81c8-660">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="a81c8-661">Contenu n’appartenant pas au compte Box migré</span><span class="sxs-lookup"><span data-stu-id="a81c8-661">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="a81c8-662">Autorisations et métadonnées de base des utilisateurs externes (<strong>remarque</strong> : utilisez les rapports Box pour identifier le contenu partagé avec des utilisateurs externes.</span><span class="sxs-lookup"><span data-stu-id="a81c8-662">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="a81c8-663">Demandez aux utilisateurs de partager à nouveau leur contenu avec les utilisateurs externes après la migration.)</span><span class="sxs-lookup"><span data-stu-id="a81c8-663">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="a81c8-664">Fichiers ou dossiers dépassant les restrictions et <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">limitations sharePoint Online actuelles</span></a> </span><span class="sxs-lookup"><span data-stu-id="a81c8-664">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="a81c8-665"><strong>Dropbox pour Teams (Standard et avancée)</strong></span><span class="sxs-lookup"><span data-stu-id="a81c8-665"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="a81c8-666">Un ou plusieurs passages</span><span class="sxs-lookup"><span data-stu-id="a81c8-666">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="a81c8-667">Documents</span><span class="sxs-lookup"><span data-stu-id="a81c8-667">Documents</span></span> </li>
<li> <span data-ttu-id="a81c8-668">Structure des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-668">File and folder structure</span></span> </li>
<li> <span data-ttu-id="a81c8-669">Autorisations de dossier au niveau de l'utilisateur\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-669">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-670">Autorisations de dossier au niveau du groupe\*</span><span class="sxs-lookup"><span data-stu-id="a81c8-670">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="a81c8-671">Fichiers inférieurs à 15 Go</span><span class="sxs-lookup"><span data-stu-id="a81c8-671">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="a81c8-672">Métadonnées de dossier et document de base :</span><span class="sxs-lookup"><span data-stu-id="a81c8-672">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="a81c8-673">Date de création</span><span class="sxs-lookup"><span data-stu-id="a81c8-673">Created date</span></span> </li>
<li> <span data-ttu-id="a81c8-674">Date de modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-674">Modified date</span></span> </li>
<li> <span data-ttu-id="a81c8-675">Créé par</span><span class="sxs-lookup"><span data-stu-id="a81c8-675">Created by</span></span> </li>
<li> <span data-ttu-id="a81c8-676">Auteur de la dernière modification</span><span class="sxs-lookup"><span data-stu-id="a81c8-676">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="a81c8-677">Dossiers et contenus collaboratifs partagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-677">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="a81c8-678">Contenu partagé appartenant au compte Dropbox en cours de migration</span><span class="sxs-lookup"><span data-stu-id="a81c8-678">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="a81c8-679">\*Les autorisations sont impactées par le groupe Microsoft 365 et/ou le canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-679">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="a81c8-680">Si la destination est un groupe Microsoft 365 ou un canal Microsoft Teams, le groupe ou le canal détermine le profil d'autorisations final sur les fichiers migrés.</span><span class="sxs-lookup"><span data-stu-id="a81c8-680">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="a81c8-681">Nous vous recommandons de ne pas migrer les autorisations sur les fichiers migrés vers un groupe Microsoft 365 ou un canal Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="a81c8-681">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span>
</td>
<td><ul>
<li> <span data-ttu-id="a81c8-682">Historique d’appartenance, versions précédentes et commentaires</span><span class="sxs-lookup"><span data-stu-id="a81c8-682">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="a81c8-683">Descriptions des fichiers et des dossiers</span><span class="sxs-lookup"><span data-stu-id="a81c8-683">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="a81c8-684">Autorisations liées aux fichiers au niveau de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="a81c8-684">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-685">Autorisations liées aux fichiers au niveau du groupe</span><span class="sxs-lookup"><span data-stu-id="a81c8-685">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="a81c8-686">Métadonnées avancées</span><span class="sxs-lookup"><span data-stu-id="a81c8-686">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="a81c8-687">Attributs de verrouillage de fichier</span><span class="sxs-lookup"><span data-stu-id="a81c8-687">File lock attributes</span></span> </li>
<li> <span data-ttu-id="a81c8-688">Conversion d’URL incorporées dans le contenu</span><span class="sxs-lookup"><span data-stu-id="a81c8-688">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="a81c8-689">Éléments jetés</span><span class="sxs-lookup"><span data-stu-id="a81c8-689">Trashed items</span></span> </li>
<li> <span data-ttu-id="a81c8-690">Documents inaccessibles ou endommagés</span><span class="sxs-lookup"><span data-stu-id="a81c8-690">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="a81c8-691">Dossiers Dropbox non montés</span><span class="sxs-lookup"><span data-stu-id="a81c8-691">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="a81c8-692">Utilisateurs supprimés ou déconnectés</span><span class="sxs-lookup"><span data-stu-id="a81c8-692">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="a81c8-693">Papier, vitrines et espaces Dropbox</span><span class="sxs-lookup"><span data-stu-id="a81c8-693">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="a81c8-694">Applications et favoris Dropbox (épingles/étoiles)</span><span class="sxs-lookup"><span data-stu-id="a81c8-694">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="a81c8-695">Contenu n’appartenant pas au compte Dropbox migré</span><span class="sxs-lookup"><span data-stu-id="a81c8-695">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="a81c8-696">Autorisations et métadonnées de base des utilisateurs externes (<strong>remarque</strong> : utilisez les rapports Dropbox pour identifier le contenu partagé avec des utilisateurs externes.</span><span class="sxs-lookup"><span data-stu-id="a81c8-696">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="a81c8-697">Demandez aux utilisateurs de partager à nouveau leur contenu avec les utilisateurs externes après la migration.)</span><span class="sxs-lookup"><span data-stu-id="a81c8-697">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="a81c8-698">Fichiers ou dossiers dépassant les restrictions et <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">limitations sharePoint Online actuelles</span></a> </span><span class="sxs-lookup"><span data-stu-id="a81c8-698">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-microsoft-teams-and-microsoft-365-groups-migrations"></a><span data-ttu-id="a81c8-699">Responsabilités FastTrack pour les migrations de Microsoft Teams et de groupes Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="a81c8-699">FastTrack responsibilities for Microsoft Teams and Microsoft 365 Groups migrations</span></span>

<span data-ttu-id="a81c8-700">Nos spécialistes FastTrack effectuent les activités standard pendant le projet de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-700">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="a81c8-701">Pour plus d’informations, voir les responsabilités relatives à la migration des données dans [Processus et attentes](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="a81c8-701">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

## <a name="your-responsibilities"></a><span data-ttu-id="a81c8-702">Vos responsabilités</span><span class="sxs-lookup"><span data-stu-id="a81c8-702">Your responsibilities</span></span> 

<span data-ttu-id="a81c8-703">Vous effectuez les activités standard pendant le projet de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-703">You perform standard activities during the migration project.</span></span> <span data-ttu-id="a81c8-704">Pour plus d’informations, voir les responsabilités relatives à la migration des données dans [Processus et attentes](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="a81c8-704">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>
<span data-ttu-id="a81c8-705">Vous effectuez également les activités suivantes, spécifiques aux migrations Microsoft Teams et Groupes Microsoft 365 :</span><span class="sxs-lookup"><span data-stu-id="a81c8-705">You also perform the following activities, specific to Microsoft Teams and Microsoft 365 Groups migrations:</span></span> 

- <span data-ttu-id="a81c8-706">Provisionnez tous les canaux Microsoft Teams et les groupes Microsoft 365 comme ciblés par vos événements de migration.</span><span class="sxs-lookup"><span data-stu-id="a81c8-706">Provision all Microsoft Teams channels and Microsoft 365 Groups as targeted by your migration events.</span></span>

> [!NOTE]
><span data-ttu-id="a81c8-707">FastTrack ne pré-provisionnise pas les canaux Microsoft Teams ou les groupes Microsoft 365.</span><span class="sxs-lookup"><span data-stu-id="a81c8-707">FastTrack doesn't pre-provision Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="a81c8-708">FastTrack n'ajoute pas d'utilisateurs finaux ou de groupes aux canaux Microsoft Teams ou aux groupes Microsoft 365.</span><span class="sxs-lookup"><span data-stu-id="a81c8-708">FastTrack doesn't add end users or groups to Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="a81c8-709">Vous devez ajouter vos utilisateurs finaux ou groupes à tous les canaux Microsoft Teams et groupes Microsoft 365 avant de migrer les données vers ces destinations afin que ces utilisateurs finaux ont accès à ces documents récemment migrés.</span><span class="sxs-lookup"><span data-stu-id="a81c8-709">You must add your end users or groups to all Microsoft Teams channels and Microsoft 365 Groups before you migrate data into those destinations so those end users have access to those newly migrated documents</span></span>