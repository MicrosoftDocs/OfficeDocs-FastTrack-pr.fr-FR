...
- *Intégration et migration de service* : les tâches d’intégration de service vous offrent plus de possibilités dans votre client. La migration de données (notamment fichiers et e-mails) est abordée dans la rubrique sur la [migration de données](data-migration.md). 
...
- L’équipe FastTrack fournit des conseils pour l’intégration de base et de service, et la planification visant à réussir l’adoption des services éligibles.
    
- FastTrack Tous les services d'intégration, de migration et d'adoption par les utilisateurs proposés par les spécialistes sont assurés à distance.
    
- Les spécialistes de FastTrack vous aident à distance à l’aide d’un ensemble d’outils et de documents publiés.
    
- L'assistance est assurée par le Service FastTrack qui est disponible pendant les heures normales d'ouverture de chaque région.
...
-  Les spécialistes de FastTrack peuvent travailler directement avec vous ou avec votre représentant. 
    
- Les spécialistes de FastTrack fournissent des conseils sur la migration des données et la messagerie.
