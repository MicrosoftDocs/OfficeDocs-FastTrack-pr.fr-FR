...
- Le Service FastTrack configure l'environnement de migration dans Azure.
    
- Le Service FastTrack configure les outils de migration sur les stations de travail d'administration locales.
    
- L'équipe du Service FastTrack configure l'outil d'importation automatique et vous montre comment l'utiliser.
    
- Le Service FastTrack effectue la validation de tous les composants de migration et effectue des migrations de test.
...
- Le centre FastTrack effectue des migrations pilote et à haute vitesse. 
    
- Le centre FastTrack génère des événements de migration et procède à des activités T-moins.
    
- Le Service FastTrack fournit une assistance après la migration.
